namespace System {
    ...
    /// <summary>Encapsulates a method that has 16 parameters and that returns a value of type <typeparamref name="TResult"/>.</summary>
    ...
    /// <typeparam name="T13">The type of parameter 13 of the function this delegate encapsulates.</typeparam>
    /// <typeparam name="T14">The type of parameter 14 of the function this delegate encapsulates.</typeparam>
    /// <typeparam name="T15">The type of parameter 15 of the function this delegate encapsulates.</typeparam>
    /// <typeparam name="T16">The type of parameter 16 of the function this delegate encapsulates.</typeparam>
