namespace System {
    ...
    /// <typeparam name="T7">The type of parameter 7 of the method this delegate encapsulates.</typeparam>
    /// <typeparam name="T8">The type of parameter 8 of the method this delegate encapsulates.</typeparam>
    /// <typeparam name="T9">The type of parameter 9 of the method this delegate encapsulates.</typeparam>
    /// <typeparam name="T10">The type of parameter 10 of the method this delegate encapsulates.</typeparam>
    /// <typeparam name="T11">The type of parameter 11 of the method this delegate encapsulates.</typeparam>
    /// <typeparam name="T12">The type of parameter 12 of the method this delegate encapsulates.</typeparam>
    /// <typeparam name="T13">The type of parameter 13 of the method this delegate encapsulates.</typeparam>
    /// <typeparam name="T14">The type of parameter 14 of the method this delegate encapsulates.</typeparam>
    /// <typeparam name="T15">The type of parameter 15 of the method this delegate encapsulates.</typeparam>
    /// <typeparam name="T16">The type of parameter 16 of the method this delegate encapsulates.</typeparam>
